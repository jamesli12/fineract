...
public class SavingsAccountsApiResource {
    ...
    public String retrieveAll(@Context final UriInfo uriInfo,
            ...
            @QueryParam("startDate") @Parameter(description = "startDate in the format 'yyyy-MM-dd'") final String startDate,
            @QueryParam("endDate") @Parameter(description = "endDate in the format 'yyyy-MM-dd'") final String endDate,
        ...
        final SearchParameters searchParameters = SearchParameters.forSavings(sqlSearch, externalId, offset, limit, orderBy, sortOrder, startDate,
                endDate);
